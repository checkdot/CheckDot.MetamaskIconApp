...
export class Web3ModalService {
  ...
  haveCachedProvider(): boolean {
    return this.web3WalletConnector.providerController.shouldCacheProvider;
  }

  connectToCachedProvider(): Promise<void> {
    return this.web3WalletConnector.providerController.connectToCachedProvider();
  }

  getCachedProvider(): IProviderDisplayWithConnector {
    return this.web3WalletConnector.providerController.getProvider(this.web3WalletConnector.providerController.cachedProvider);
  }
